...
Route::post('conversations/{conversation}/participants', 'ConversationController@join');
Route::delete('conversations/{conversation}/participants', 'ConversationController@leaveConversation');
